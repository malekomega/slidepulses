...
<a href="/dashboard" style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: 16, letterSpacing: "-0.02em", color: "#E2E8F0", textDecoration: "none", cursor: "pointer" }}>← SlidePulse</a>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          ...
          <div style={{ width: 1, height: 24, background: "#1e2235", margin: "0 6px" }} />
          <ToolBtn icon={<Icons.Share />} label="Share" onClick={() => { if (!presentationId) { alert("Save the presentation first."); return; } const url = window.location.origin + "/join"; navigator.clipboard.writeText(url).then(() => alert("Share link copied: " + url)).catch(() => prompt("Copy this link:", url)); }} />
